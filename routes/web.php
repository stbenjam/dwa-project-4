...
Route::get('/credit_cards/{credit_card_id}/categories/{category_id}/edit', 'CreditCardCategoriesController@edit');
Route::put('/credit_cards/{credit_card_id}/categories/{category_id}', 'CreditCardCategoriesController@update');
